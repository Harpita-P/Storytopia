...
**Storytopia** transforms a child’s drawing into a narrated, illustrated 8-scene quest (story adventure), blending imagination with AI creativity.  
Built for the **Google Cloud Hackathon**, Storytopia demonstrates how **multi-agent orchestration with Google ADK**, **Vertex AI**, and **Cloud Run** can turn screen time into a hands-on creative adventure.
